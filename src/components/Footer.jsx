...
export default function Footer() {
  return (
    <footer
      className="bg-white text-center text-neutral-600 dark:bg-black dark:text-neutral-200 lg:text-left">
      <div
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            <h6
              className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start text-yellow-400">
